...
# XML Post API
<AccessWarning />
Rehberinize, HTTP protokolünün POST methodunu kullanarak, XML formatında rehberinizdeki kişiyi düzenlemek için, aşağıdaki yönergeleri takip edebilirsiniz.
