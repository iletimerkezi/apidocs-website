---
slug: /rehber/grup/kisi/cikar/json/
sidebar_label: JSON
sidebar_position: 1
---
...
# JSON Post API
<AccessWarning />
Rehberinizde var olan kişi veya kişileri, HTTP protokolünün POST methodunu kullanarak, XML formatında belirtmiş olduğunuz gruptan çıkarmak için, aşağıdaki yönergeleri takip edebilirsiniz.
...
#### contact
Gruptan çıkarılacak, kişilerin bilgisini içerir. Alt etiketleri aşağıdaki gibidir.
  + **id:** Kişiyi temsil benzersiz nümerik id değeri.

#### group
Kişilerin çıkarılacağı grubu ifade eder. Alt etiketi aşağıdaki gibidir.
