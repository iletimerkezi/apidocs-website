...
# XML Post API
<AccessWarning />
Rehberinizdeki bir grubun bilgilerini, HTTP protokolünün POST metodunu kullanarak, XML formatında değiştirmek için, aşağıdaki yönergeleri takip edebilirsiniz.
