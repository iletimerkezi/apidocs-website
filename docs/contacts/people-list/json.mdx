...
# JSON Post API
<AccessWarning />
Rehberinizde tanımlı bir grubun içindeki kişileri, HTTP protokolünün POST metodunu kullanarak, JSON formatında almak için, aşağıdaki yönergeleri takip edebilirsiniz.
