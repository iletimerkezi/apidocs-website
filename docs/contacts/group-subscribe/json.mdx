---
slug: /rehber/grup/kisi/ekle/json/
sidebar_label: JSON
sidebar_position: 1
---
...
# JSON Post API
<AccessWarning />
Rehberinizde var olan kişi veya kişileri, HTTP protokolünün POST methodunu kullanarak, XML formatında belirtmiş olduğunuz gruba dahil olması için, aşağıdaki yönergeleri takip edebilirsiniz.
...
#### group
Kişilerin ekleneceği grubu ifade eder. Alt etiketi aşağıdaki gibidir.
