...
# XML Post API
<AccessWarning />
Rehberinizdeki kişileri, HTTP protokolünün POST metodunu kullanarak, XML formatında aramak için, aşağıdaki yönergeleri takip edebilirsiniz.
...
<ErrorCodeTable codes={[400, 401, 404, 465, 471]} />