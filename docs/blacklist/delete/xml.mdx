...
# XML Post API
Numara engelleme listesine eklediğiniz bir cep telefonu numarasını, HTTP protokolünün POST metodunu kullanarak, XML formatında ileterek engellenmiş numara listenizden çıkarmak isterseniz, aşağıdaki yönergeleri takip edebilirsiniz.
