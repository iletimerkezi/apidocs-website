...
# JSON Post API
Numara engelleme listesine eklediğiniz bir cep telefonu numarasını, HTTP protokolünün POST methodunu kullanarak, JSON formatında ileterek engellenmiş numara listenizden çıkarmak isterseniz, aşağıdaki yönergeleri takip edebilirsiniz.

## İstek yapılacak adres

<RequestURL type="POST" url="http://api.iletimerkezi.com/v1/delete-blacklist/json" />
