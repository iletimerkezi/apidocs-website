---
slug: /contacts/group/people/xml/
sidebar_label: XML
sidebar_position: 0
---
...
# XML Post API
<AccessWarning />
You can follow the instructions below to get the contacts in a group defined in your directory in XML format using the POST method of the HTTP protocol.
