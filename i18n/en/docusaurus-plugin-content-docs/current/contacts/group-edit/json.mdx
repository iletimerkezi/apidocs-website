...
# JSON Post API
<AccessWarning />
You can follow the instructions below to change the information of a group in your directory in JSON format using the POST method of the HTTP protocol.
