---
slug: /contacts/group/people/unsubscribe/json/
sidebar_label: JSON
sidebar_position: 1
---
...
<RequestURL type="POST" url="https://api.iletimerkezi.com/v1/unsubscribe-group/json" />
...
#### contact
Contains information of people to be removed from the group. The alt tags are as follows.
  + **id:** Unique numeric id value representing the person.

#### group
Indicates the group from which people will be removed. The alt tag is as follows.
