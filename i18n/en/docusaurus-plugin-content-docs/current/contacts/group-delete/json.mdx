---
slug: /contacts/group/delete/json/
sidebar_label: JSON
sidebar_position: 1
---
...
# JSON Post API
<AccessWarning />
You can follow the instructions below to delete a group in your directory in JSON format using the POST method of the HTTP protocol.
