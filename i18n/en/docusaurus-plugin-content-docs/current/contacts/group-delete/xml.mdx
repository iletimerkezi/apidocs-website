---
slug: /contacts/group/delete/xml/
sidebar_label: XML
sidebar_position: 0
---
...
# XML Post API
<AccessWarning />
You can follow the instructions below to delete a group in your directory in XML format using the POST method of the HTTP protocol.
...
#### group
Contains information about the group to be deleted. It doesn't repeat. The alt tags are as follows.

+ **id:** Contains the unique id of the group to be deleted.
