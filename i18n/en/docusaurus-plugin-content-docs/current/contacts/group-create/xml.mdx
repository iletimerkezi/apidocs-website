...
# XML Post API
<AccessWarning />
You can follow the instructions below to create a new group in your directory in XML format using the POST method of the HTTP protocol.
