...
# XML Post API
If you want to add a phone number that you do not wish to send SMS to, to your blacklist by submitting it in XML format using the POST method of the HTTP protocol, you can follow the instructions below.
