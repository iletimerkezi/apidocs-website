...
# JSON Post API
If you want to remove a phone number that you have added to the blacklist from your blocked number list by submitting it in JSON format using the POST method of the HTTP protocol, you can follow the instructions below.
