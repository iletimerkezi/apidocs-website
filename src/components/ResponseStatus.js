...
export default function ResponseStatus() {
  ...
  return (
    <>
      <h4 class="anchor anchorWithHideOnScrollNavbar_node_modules-@docusaurus-theme-classic-lib-theme-Heading-styles-module" id="status">
        status
        <a class="hash-link" href="#status" title="Başlığa doğrudan bağlantı">​</a>
      </h4>
      <p>
